...
| `fm-session-lock-lib.sh` | Shared session-lock identity (session id, harness ancestry walk, and competing-holder liveness) for fm-lock.sh and the Claude Stop auto-arm |
