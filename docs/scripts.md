...
| `fm-project-mode.sh`     | Resolve a project's registered delivery posture and `+planning` marker from `data/projects.md` for fleet sync, home seeding, and the ship-brief planning-context guard |
