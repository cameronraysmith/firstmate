...
test_cursor_marker_outranks_inherited_claudecode() {
  ...
  out=$(env -u CURSOR_AGENT -u CURSOR_INVOKED_AS -u OMPCODE -u ATOMIC_CODING_AGENT CLAUDECODE=1 "$HARNESS")
  ...
  out=$(env -u CURSOR_AGENT -u OMPCODE -u ATOMIC_CODING_AGENT CLAUDECODE=1 CURSOR_API_ENDPOINT=https://example \
