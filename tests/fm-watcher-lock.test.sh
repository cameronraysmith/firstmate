...
test_guard_warnings() {
  ...
  CLAUDECODE=1 OMPCODE='' ATOMIC_CODING_AGENT='' PI_CODING_AGENT='' GROK_AGENT='' FM_ROOT_OVERRIDE="$dir" FM_STATE_OVERRIDE="$state" FM_GUARD_GRACE=1 "$ROOT/bin/fm-guard.sh" 2> "$err" >/dev/null || fail "guard failed"
