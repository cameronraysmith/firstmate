...
unset CLAUDECODE OMPCODE ATOMIC_CODING_AGENT PI_CODING_AGENT FM_PI_HARNESS GROK_AGENT CURSOR_AGENT CURSOR_INVOKED_AS
...
omp is a distinct secondmate value, never folded into pi^codex^omp^omp^codex
