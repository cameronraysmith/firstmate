...
# One spelling of the fixture root, because the owner check below compares it
# against a process argv. A TMPDIR that ends in a slash (the macOS default)
